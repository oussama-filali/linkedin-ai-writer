...
# 📚 Documentation LinkedIn AI Writer

Documentation technique complète du projet.

## ⚠️ Note Importante

Ce dossier contient des informations sensibles et des détails techniques confidentiels. 
...
Ne partagez jamais ces fichiers publiquement car ils peuvent contenir :
- URLs de services
- Configurations internes
- Détails d'infrastructure
- Historique de développement

Pour la documentation publique, consultez le `README.md` à la racine du projet.
